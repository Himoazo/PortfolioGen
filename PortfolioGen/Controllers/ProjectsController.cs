...
namespace PortfolioGen.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,ImageUrl,ProjectUrl,CreatedAt,PortfolioId")] Project project)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,ImageUrl,ProjectUrl,CreatedAt,PortfolioId")] Project project)
        {
            if (id != project.Id)
            {
                return NotFound();
